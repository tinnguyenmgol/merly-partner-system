...
Required environment variables are `HARAVAN_SHOP_DOMAIN` and `HARAVAN_ACCESS_TOKEN`. Keep real Haravan credentials in runtime secrets only; do not commit them.
