...
export default async function Page({ searchParams }: { searchParams: Promise<{ q?: string; synced?: string }> }) {
  await requireAdminSession();
  const { q = "", synced } = await searchParams;
